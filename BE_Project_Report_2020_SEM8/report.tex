...
\fancyfoot[L]{\emph{Department of Information Technology, DBIT, Mumbai}}
\cfoot{}
\fancyfoot[R]{\thepage}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}
...
%includes the University Cover Page
\input{project/cover-univ.tex}
\newpage
...
\titlespacing{\chapter}{0pt}{216pt}{0pt}

\input{project/chapter1.tex} % adds the introduction page
\input{project/chapter2.tex} % adds the Literature Survey page
...
\addcontentsline{toc}{section}{Data Sheet(s) - Electronic component}  
\addcontentsline{toc}{section}{Installation Procedure - Development Software}
%\newpage
% \input{project/ref.tex} % adds the References page
% \addcontentsline{toc}{part}{References}
\newpage
\addcontentsline{toc}{part}{Technical Paper in IEEE Format}
